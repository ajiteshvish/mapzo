    ...
    sections: [
      {
        title: 'For Teams',
        items: [
          { icon: Users, label: 'For Agencies', description: 'Handle more local SEO client profiles with automation', href: '/book-demo', badge: 'Book Demo' },
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="hidden lg:flex items-center gap-4">
              ...
              <Button variant="hero" size="default" className="shadow-soft hover-lift" asChild>
                <a href="https://login.mapzoai.com/">Sign Up/Sign In</a>
              </Button>
            </div>
        ...
        <AnimatePresence>
          {isMobileMenuOpen && (
            <motion.div
              ...
              exit={{ opacity: 0, y: -20 }}
              className="lg:hidden absolute top-full left-0 right-0 bg-white/95 backdrop-blur-md border-t border-neutral-200 shadow-lg h-[calc(100vh-100%)] overflow-y-auto"
            >
